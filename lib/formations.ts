...
export const FORMATIONS: Record<string, Slot[]> = {
  "4-3-3": [
    ...
    { id: "RB", x: 90, y: 70, label: "RB" },
    { id: "RCB", x: 68, y: 76, label: "CB" },
    { id: "LCB", x: 32, y: 76, label: "CB" },
    { id: "LB", x: 10, y: 70, label: "LB" },
    { id: "RCM", x: 74, y: 48, label: "CM" },
    { id: "CM", x: 50, y: 58, label: "CM" },
    { id: "LCM", x: 26, y: 48, label: "CM" },
    { id: "RW", x: 86, y: 24, label: "RW" },
    { id: "ST", x: 50, y: 16, label: "ST" },
  ...
  "4-2-3-1": [
    ...
    { id: "LCB", x: 32, y: 76, label: "CB" },
    { id: "LB", x: 10, y: 70, label: "LB" },
    { id: "RDM", x: 66, y: 58, label: "CDM" },
    { id: "LDM", x: 34, y: 58, label: "CDM" },
    { id: "RAM", x: 86, y: 34, label: "RM" },
    { id: "CAM", x: 50, y: 36, label: "CAM" },
    { id: "LAM", x: 14, y: 34, label: "LM" },
  ...
  "4-4-2": [
    ...
    { id: "LCB", x: 32, y: 76, label: "CB" },
    { id: "LB", x: 10, y: 70, label: "LB" },
    { id: "RM", x: 90, y: 48, label: "RM" },
    { id: "RCM", x: 64, y: 54, label: "CM" },
    { id: "LCM", x: 36, y: 54, label: "CM" },
    { id: "LM", x: 10, y: 48, label: "LM" },
    { id: "RST", x: 64, y: 18, label: "ST" },
    { id: "LST", x: 36, y: 18, label: "ST" },
  ],
  "4-2-2-2": [
    { id: "GK", x: 50, y: 96, label: "GK" },
    { id: "RB", x: 90, y: 70, label: "RB" },
    ...
    { id: "LCB", x: 32, y: 76, label: "CB" },
    { id: "LB", x: 10, y: 70, label: "LB" },
    { id: "RDM", x: 66, y: 56, label: "CDM" },
    { id: "LDM", x: 34, y: 56, label: "CDM" },
    { id: "RAM", x: 78, y: 34, label: "CAM" },
    { id: "LAM", x: 22, y: 34, label: "CAM" },
    { id: "RST", x: 64, y: 16, label: "ST" },
    { id: "LST", x: 36, y: 16, label: "ST" },
  ],
  "3-5-2": [
    { id: "GK", x: 50, y: 96, label: "GK" },
    { id: "RCB", x: 76, y: 74, label: "CB" },
    { id: "CB", x: 50, y: 78, label: "CB" },
    { id: "LCB", x: 24, y: 74, label: "CB" },
    { id: "RWB", x: 92, y: 48, label: "RWB" },
    { id: "RCM", x: 66, y: 50, label: "CM" },
    { id: "CM", x: 50, y: 58, label: "CDM" },
    { id: "LCM", x: 34, y: 50, label: "CM" },
    { id: "LWB", x: 8, y: 48, label: "LWB" },
    { id: "RST", x: 64, y: 18, label: "ST" },
    { id: "LST", x: 36, y: 18, label: "ST" },
  ],
};
